...
const Invoice = () => {
    ...
    const handleDowload=()=>{
        //generer un pdf pour la facture
  ...
  return (
    ...
    <div className="order-invoice my-5">
      <div className="row d-flex justify-content-center mb-5">
        <button className="btn btn-success col-md-5" onClick={handleDowload}>
      ...
      <div id="order_invoice" className="p-3 border border-secondary">
        <header className="clearfix">
          ...
          <div id="project">
            ...
            <div><span>DATE</span> {new Date(data?.order?.createdAt).toLocaleDateString("en-US")}</div>
